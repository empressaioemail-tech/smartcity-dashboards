 ...
 * Product-safe labels: no retired SKU names, no lowercase vendor product paths.
 */
...
export const SHELL_HOMES = [
  ...
  { table: "primary", job: "Workspace launch cards", home: "Sidebar", disposition: "Killed" },
  { table: "primary", job: "City calendar", home: "Overview Public meetings; Citizen Meetings", disposition: "Mounted" },
  { table: "primary", job: "Live City Pulse / data-source dots", home: "Overview Across departments; City Connections", disposition: "Mounted / Empty" },
  ...
  { table: "primary", job: "Permit fee revenue", home: "Finance source register, Partial", disposition: "Empty" },
  ...
  { table: "primary", job: "Second parcel map stack", home: "Killed as a product map", disposition: "Island" },
  ...
  { table: "primary", job: "Cameras", home: "Police (Verkada)", disposition: "Not built" },
  ...
  { table: "primary", job: "Compass chatbot", home: "Compass top-bar sheet", disposition: "Mounted chrome" },
  { table: "primary", job: "Public morning brief", home: "Killed on unauth Dashboards", disposition: "Killed" },
  { table: "primary", job: "Prophecy document search", home: "Work Records search", disposition: "Not built" },
  { table: "review-product", job: "Reviewer queue", home: "Work Plan review", disposition: "Mounted" },
  ...
  { table: "review-product", job: "Nested review product chrome", home: "none", disposition: "Killed" },
  ...
  { table: "products", job: "AI Plan Review / Codex 1b", home: "Work Plan review", disposition: "Mounted" },
  { table: "products", job: "Citizen public SKU", home: "Citizen", disposition: "Killed" },
  { table: "products", job: "3D city model product", home: "none", disposition: "Killed" },
  { table: "products", job: "Compass", home: "Top-bar sheet", disposition: "Mounted chrome" },
  ...
  { table: "feeds", job: "ArcGIS / Esri", home: "Place map (SmartSite)", disposition: "Mounted" },
  ...
  { table: "feeds", job: "Municode calendar", home: "Overview Public meetings", disposition: "Home exists" },
  { table: "feeds", job: "Anthropic", home: "Compass", disposition: "Chrome only" },
  { table: "feeds", job: "CRM feed", home: "none", disposition: "Killed" },
  ...
  { table: "other", job: "Design lab", home: "none", disposition: "Killed" },
  { table: "other", job: "Data audit", home: "Connections", disposition: "Not built" },
  { table: "other", job: "Departments including Parks and Courts", home: "Parks; Courts on Connections", disposition: "Not built" },
  { table: "other", job: "Citizen twelve tiles", home: "Citizen", disposition: "Mounted" },
  { table: "other", job: "Auth / session / notifications / theme / sign out", home: "Top bar; People and access", disposition: "Not built" },
  { table: "other", job: "Status bar integration count", home: "Connections; nav footer", disposition: "Empty" },
...
export function dispositionPill(disposition) {
  ...
  if (d === "Mounted" || d === "Mounted chrome" || d === "Home exists" || d === "Chrome only") return "p-restricted";
  if (d === "Island" || d === "Mounted / Empty" || d === "Partial") return "p-warn";
  return "p-quiet";
}
...
export function homeRowHtml(row, index) {
  ...
  return `<div class="srcreg" data-home-row="${index + 1}" data-home-table="${escapeHtml(row.table)}"><i class="rail"></i><span class="nm"><b>${job}</b><span>${home}</span></span><span class="pill ${pill}">${disposition}</span></div>`;
}

export function connectionsRegisterHtml(rows = SHELL_HOMES) {
