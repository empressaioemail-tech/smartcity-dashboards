...
- Neon: pooled `ep-still-wave-avbwm4yc-pooler.c-11.us-east-1.aws.neon.tech`, database `neondb`. DSN is gitignored and Secret Manager `database-url`. Not `tiny-art-63602898`, not `fancy-fire-06136146`, not the city DB.
